...
TODO: Make sure to implement "code font" for keywords in this README
...
2. Extract all "import" statements with regex ("import X" or "from X import")
3. Map import names to package names (TODO: CHANGE THIS SO THAT YOU DON'T NEED A DICT AND IT IS AUTOMATIC)
